        ...
        if (!finished) {
            if (value == -1) {
                ...
                if (value > 0) {
                    // Tim den dich
                    value = 0;
                    String temp = "Đường đi là: " + bfsAlgorithm.getPath() + "\nChi phí là: " + String.valueOf(bfsAlgorithm.getCost());
                    ...
                    if (value == 0) {
                        ...
                        parentContent.setText("(Đỉnh, Đỉnh cha): " + bfsAlgorithm.getParents());
                        queueContent.setText("(Đỉnh, độ dài): " + bfsAlgorithm.getQueue());
